      ...
      <div className="container mx-auto">
        ...
        <main className="flex-grow px-4 py-8 flex justify-center">
          <div className="w-full max-w-md">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Minton’s Token Forge</h2>
            <p className="text-gray-600 mb-6 text-center">Minton says: Let’s craft your token on Shardeum!</p>
